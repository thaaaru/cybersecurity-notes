...
- [[6.8.1.1-Installing-Burp-Suite-CommunityProfessional|↓ Installing Burp Suite Community/Professional]]
- [[6.8.1.2-Browser-proxy-configuration-and-CA-certificate|↓ Browser proxy configuration and CA certificate]]
- [[6.8.1.3-Target-scope-definition-and-project-management|↓ Target scope definition and project management]]

**Related Topics at Same Level:**
- [[6.8.2-Core-Burp-Suite-tools-and-features|→ Core Burp Suite tools and features]]
