...
- [[6.9.1.1-API-keys-OAuth-20-JWT-tokens|↓ API keys, OAuth 2.0, JWT tokens]]
- [[6.9.1.2-Bearer-token-vulnerabilities-and-protection|↓ Bearer token vulnerabilities and protection]]
- [[6.9.1.3-API-authorization-and-scope-management|↓ API authorization and scope management]]

**Related Topics at Same Level:**
- [[6.9.2-API-abuse-and-protection-mechanisms|→ API abuse and protection mechanisms]]
- [[6.9.3-REST-and-GraphQL-API-security|→ REST and GraphQL API security]]
