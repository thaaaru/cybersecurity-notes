# DOM-based XSS and prevention strategies
...
- [[6.3.3.1-Client-side-JavaScript-vulnerabilities|↓ Client-side JavaScript vulnerabilities]]
- [[6.3.3.2-Dangerous-sinks-innerHTML-eval-documentwrite|↓ Dangerous sinks: innerHTML, eval, document.write]]
- [[6.3.3.3-Content-Security-Policy-CSP-implementation|↓ Content Security Policy (CSP) implementation]]

**Related Topics at Same Level:**
- [[6.3.1-Reflected-XSS-attacks|→ Reflected XSS attacks]]
