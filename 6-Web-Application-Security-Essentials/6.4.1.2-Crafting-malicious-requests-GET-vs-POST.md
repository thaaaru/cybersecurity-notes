...
**ID:** 6.4.1.2
**Level:** 4
**Parent:** [[6.4.1-CSRF-attack-mechanism-and-exploitation|CSRF attack mechanism and exploitation]]
**Tags:** #level4 #os-security #module6
...
- [[6.4.1.1-Understanding-session-based-authentication-vulnerability|→ Understanding session-based authentication vulnerability]]
- [[6.4.1.3-CSRF-impact-Account-takeover-unauthorized-actions|→ CSRF impact: Account takeover, unauthorized actions]]
