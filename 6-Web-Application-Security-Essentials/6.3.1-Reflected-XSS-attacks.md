...
**ID:** 6.3.1
**Level:** 3
**Parent:** [[6.3-Cross-Site-Scripting-XSS-Reflected-Stored-and-DOM-based|Cross-Site Scripting (XSS): Reflected, Stored, and DOM-based]]
...
- [[6.3.1.1-Identifying-reflection-points-in-applications|↓ Identifying reflection points in applications]]
- [[6.3.1.2-Crafting-XSS-payloads-alert-onerror-script-tags|↓ Crafting XSS payloads: alert(), onerror, script tags]]
- [[6.3.1.3-URL-encoding-and-filter-bypass-techniques|↓ URL encoding and filter bypass techniques]]

**Related Topics at Same Level:**
- [[6.3.2-Stored-Persistent-XSS-vulnerabilities|→ Stored (Persistent) XSS vulnerabilities]]
- [[6.3.3-DOM-based-XSS-and-prevention-strategies|→ DOM-based XSS and prevention strategies]]
