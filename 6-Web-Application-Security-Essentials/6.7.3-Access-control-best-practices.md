...
**ID:** 6.7.3
**Level:** 3
**Parent:** [[6.7-Insecure-Direct-Object-References-IDOR-and-access-control-issues|Insecure Direct Object References (IDOR) and access control issues]]
**Tags:** #level3 #module6
...
- [[6.7.3.1-Server-side-authorization-checks|↓ Server-side authorization checks]]
- [[6.7.3.2-Indirect-object-references-and-mapping-tables|↓ Indirect object references and mapping tables]]
- [[6.7.3.3-Deny-by-default-and-whitelist-approach|↓ Deny by default and whitelist approach]]

**Related Topics at Same Level:**
- [[6.7.1-IDOR-vulnerability-identification|→ IDOR vulnerability identification]]
- [[6.7.2-Broken-access-control-patterns|→ Broken access control patterns]]
