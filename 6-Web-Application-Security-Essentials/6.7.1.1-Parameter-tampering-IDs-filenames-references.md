...
**ID:** 6.7.1.1
**Level:** 4
**Parent:** [[6.7.1-IDOR-vulnerability-identification|IDOR vulnerability identification]]
**Tags:** #level4 #module6
...
- [[6.7.1-IDOR-vulnerability-identification|↑ IDOR vulnerability identification]]

**Related Topics at Same Level:**
- [[6.7.1.2-Horizontal-vs-vertical-privilege-escalation|→ Horizontal vs vertical privilege escalation]]
- [[6.7.1.3-IDOR-in-APIs-and-mobile-applications|→ IDOR in APIs and mobile applications]]
