# Injection prevention and secure coding

**ID:** 6.2.3
**Level:** 3
**Parent:** [[6.2-Injection-attacks-SQL-injection-command-injection-LDAP-injection|Injection attacks: SQL injection, command injection, LDAP injection]]
**Tags:** #level3 #module6
...
- [[6.2.3.1-Parameterized-queries-and-prepared-statements|↓ Parameterized queries and prepared statements]]
- [[6.2.3.2-Input-validation-and-sanitization-best-practices|↓ Input validation and sanitization best practices]]
- [[6.2.3.3-Principle-of-least-privilege-for-database-accounts|↓ Principle of least privilege for database accounts]]

**Related Topics at Same Level:**
- [[6.2.1-SQL-injection-fundamentals|→ SQL injection fundamentals]]
- [[6.2.2-Command-injection-and-OS-command-execution|→ Command injection and OS command execution]]
