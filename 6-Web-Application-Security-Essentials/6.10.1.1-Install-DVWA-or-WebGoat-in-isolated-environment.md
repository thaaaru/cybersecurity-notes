# Install DVWA or WebGoat in isolated environment

**ID:** 6.10.1.1
**Level:** 4
**Parent:** [[6.10.1-Setup-vulnerable-application-environment|Setup vulnerable application environment]]
**Tags:** #level4 #web-security #compliance #module6
