...
**ID:** 6.10.2.1
**Level:** 4
**Parent:** [[6.10.2-Exploit-common-web-vulnerabilities|Exploit common web vulnerabilities]]
...
- [[6.10.2.2-Exploit-XSS-vulnerabilities-reflected-stored-DOM|→ Exploit XSS vulnerabilities (reflected, stored, DOM)]]
- [[6.10.2.3-Test-CSRF-authentication-bypass-and-file-upload-issues|→ Test CSRF, authentication bypass, and file upload issues]]
