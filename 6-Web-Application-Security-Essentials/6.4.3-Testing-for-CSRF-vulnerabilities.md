...
**ID:** 6.4.3
**Level:** 3
**Parent:** [[6.4-Cross-Site-Request-Forgery-CSRF-and-prevention-techniques|Cross-Site Request Forgery (CSRF) and prevention techniques]]
**Tags:** #level3 #module6
...
- [[6.4.3.1-Identifying-state-changing-operations|↓ Identifying state-changing operations]]
- [[6.4.3.2-CSRF-proof-of-concept-PoC-creation|↓ CSRF proof-of-concept (PoC) creation]]
- [[6.4.3.3-Burp-Suite-CSRF-PoC-generator|↓ Burp Suite CSRF PoC generator]]

**Related Topics at Same Level:**
- [[6.4.1-CSRF-attack-mechanism-and-exploitation|→ CSRF attack mechanism and exploitation]]
- [[6.4.2-CSRF-prevention-mechanisms|→ CSRF prevention mechanisms]]
