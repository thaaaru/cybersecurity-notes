...
- [[6.7.2.1-Missing-function-level-access-control|↓ Missing function-level access control]]
- [[6.7.2.2-Path-traversal-and-directory-traversal|↓ Path traversal and directory traversal]]
- [[6.7.2.3-Forced-browsing-and-unprotected-endpoints|↓ Forced browsing and unprotected endpoints]]

**Related Topics at Same Level:**
- [[6.7.1-IDOR-vulnerability-identification|→ IDOR vulnerability identification]]
- [[6.7.3-Access-control-best-practices|→ Access control best practices]]
