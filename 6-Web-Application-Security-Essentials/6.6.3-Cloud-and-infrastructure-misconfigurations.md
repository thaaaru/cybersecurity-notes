...
**ID:** 6.6.3
**Level:** 3
**Parent:** [[6.6-Security-misconfiguration-Default-credentials-unnecessary-services|Security misconfiguration: Default credentials, unnecessary services]]
**Tags:** #level3 #cloud-security #module6
...
- [[6.6.3.2-Open-database-ports-and-weak-firewall-rules|↓ Open database ports and weak firewall rules]]
- [[6.6.3.3-Configuration-management-and-hardening-guides|↓ Configuration management and hardening guides]]

**Related Topics at Same Level:**
- [[6.6.1-Common-security-misconfigurations|→ Common security misconfigurations]]
- [[6.6.2-Application-and-framework-misconfigurations|→ Application and framework misconfigurations]]
