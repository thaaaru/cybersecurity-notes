...
**ID:** 6.5.1
**Level:** 3
**Parent:** [[6.5-Broken-authentication-and-session-management-vulnerabilities|Broken authentication and session management vulnerabilities]]
**Tags:** #level3 #module6
...
- [[6.5.1.1-Weak-password-policies-and-credential-stuffing|↓ Weak password policies and credential stuffing]]
- [[6.5.1.2-Authentication-logic-flaws-and-bypasses|↓ Authentication logic flaws and bypasses]]
- [[6.5.1.3-Multi-factor-authentication-bypass-methods|↓ Multi-factor authentication bypass methods]]

**Related Topics at Same Level:**
- [[6.5.2-Session-management-vulnerabilities|→ Session management vulnerabilities]]
- [[6.5.3-Secure-authentication-implementation|→ Secure authentication implementation]]
