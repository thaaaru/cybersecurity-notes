# Core Burp Suite tools and features

**ID:** 6.8.2
**Level:** 3
**Parent:** [[6.8-Using-Burp-Suite-for-web-application-security-testing|Using Burp Suite for web application security testing]]
...
- [[6.8.2.1-Proxy-Intercepting-and-modifying-requests|↓ Proxy: Intercepting and modifying requests]]
- [[6.8.2.2-Repeater-Manual-request-manipulation|↓ Repeater: Manual request manipulation]]
- [[6.8.2.3-Intruder-Automated-payload-injection-and-fuzzing|↓ Intruder: Automated payload injection and fuzzing]]

**Related Topics at Same Level:**
- [[6.8.1-Burp-Suite-setup-and-proxy-configuration|→ Burp Suite setup and proxy configuration]]
- [[6.8.3-Advanced-Burp-Suite-techniques|→ Advanced Burp Suite techniques]]
