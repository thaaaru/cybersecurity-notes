...
- [[6.2.1.1-In-band-SQLi-Union-based-and-error-based|↓ In-band SQLi: Union-based and error-based]]
- [[6.2.1.2-Blind-SQLi-Boolean-based-and-time-based|↓ Blind SQLi: Boolean-based and time-based]]
- [[6.2.1.3-SQL-injection-payloads-and-database-fingerprinting|↓ SQL injection payloads and database fingerprinting]]

**Related Topics at Same Level:**
- [[6.2.2-Command-injection-and-OS-command-execution|→ Command injection and OS command execution]]
- [[6.2.3-Injection-prevention-and-secure-coding|→ Injection prevention and secure coding]]
