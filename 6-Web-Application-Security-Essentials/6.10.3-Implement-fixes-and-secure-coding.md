...
**ID:** 6.10.3
**Level:** 3
**Parent:** [[6.10-Lab-Exploit-and-fix-vulnerabilities-in-DVWA-or-WebGoat|Lab: Exploit and fix vulnerabilities in DVWA or WebGoat]]
**Tags:** #level3 #module6
...
- [[6.10.3.1-Review-vulnerable-source-code|↓ Review vulnerable source code]]
- [[6.10.3.2-Apply-secure-coding-fixes-for-each-vulnerability|↓ Apply secure coding fixes for each vulnerability]]
- [[6.10.3.3-Verify-fixes-and-create-remediation-documentation|↓ Verify fixes and create remediation documentation]]

**Related Topics at Same Level:**
- [[6.10.1-Setup-vulnerable-application-environment|→ Setup vulnerable application environment]]
- [[6.10.2-Exploit-common-web-vulnerabilities|→ Exploit common web vulnerabilities]]
