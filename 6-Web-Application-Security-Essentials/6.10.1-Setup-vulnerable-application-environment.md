...
- [[6.10.1.1-Install-DVWA-or-WebGoat-in-isolated-environment|↓ Install DVWA or WebGoat in isolated environment]]
- [[6.10.1.2-Configure-security-levels-Low-Medium-High|↓ Configure security levels: Low, Medium, High]]
- [[6.10.1.3-Set-up-Burp-Suite-proxy-for-testing|↓ Set up Burp Suite proxy for testing]]

**Related Topics at Same Level:**
- [[6.10.2-Exploit-common-web-vulnerabilities|→ Exploit common web vulnerabilities]]
- [[6.10.3-Implement-fixes-and-secure-coding|→ Implement fixes and secure coding]]
