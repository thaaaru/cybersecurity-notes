...
**ID:** 6.9.3
**Level:** 3
**Parent:** [[6.9-API-security-basics-Authentication-rate-limiting-input-validation|API security basics: Authentication, rate limiting, input validation]]
...
- [[6.9.3.1-REST-API-security-best-practices|↓ REST API security best practices]]
- [[6.9.3.2-GraphQL-introspection-and-query-depth-limiting|↓ GraphQL introspection and query depth limiting]]
- [[6.9.3.3-API-documentation-security-SwaggerOpenAPI|↓ API documentation security: Swagger/OpenAPI]]

**Related Topics at Same Level:**
- [[6.9.1-API-authentication-and-authorization|→ API authentication and authorization]]
- [[6.9.2-API-abuse-and-protection-mechanisms|→ API abuse and protection mechanisms]]
