...
- [[6.4.2.1-Anti-CSRF-tokens-synchronizer-tokens|↓ Anti-CSRF tokens (synchronizer tokens)]]
- [[6.4.2.2-SameSite-cookie-attribute|↓ SameSite cookie attribute]]
- [[6.4.2.3-Double-submit-cookie-pattern|↓ Double-submit cookie pattern]]

**Related Topics at Same Level:**
- [[6.4.1-CSRF-attack-mechanism-and-exploitation|→ CSRF attack mechanism and exploitation]]
- [[6.4.3-Testing-for-CSRF-vulnerabilities|→ Testing for CSRF vulnerabilities]]
