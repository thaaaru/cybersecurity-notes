...
- [[6.6.2.1-Debug-mode-enabled-in-production|↓ Debug mode enabled in production]]
- [[6.6.2.2-Missing-security-headers-HSTS-X-Frame-Options|↓ Missing security headers: HSTS, X-Frame-Options]]
- [[6.6.2.3-Outdated-and-vulnerable-components|↓ Outdated and vulnerable components]]
