...
**ID:** 2.2.3
**Level:** 3
**Parent:** [[2.2-Common-network-protocols-HTTPHTTPS-DNS-FTP-SSH-Telnet|Common network protocols: HTTP/HTTPS, DNS, FTP, SSH, Telnet]]
**Tags:** #level3 #module2
...
- [[2.2.3.1-SSH-Key-based-authentication-and-secure-tunneling|↓ SSH: Key-based authentication and secure tunneling]]
- [[2.2.3.2-Telnet-and-FTP-Cleartext-vulnerabilities|↓ Telnet and FTP: Cleartext vulnerabilities]]
- [[2.2.3.3-SFTP-and-SCP-as-secure-alternatives|↓ SFTP and SCP as secure alternatives]]

**Related Topics at Same Level:**
- [[2.2.1-HTTP-vs-HTTPS-Web-communication-protocols|→ HTTP vs HTTPS: Web communication protocols]]
- [[2.2.2-DNS-protocol-and-name-resolution-process|→ DNS protocol and name resolution process]]
