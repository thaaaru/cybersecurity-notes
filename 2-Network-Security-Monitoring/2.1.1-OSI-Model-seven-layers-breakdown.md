# OSI Model seven layers breakdown

**ID:** 2.1.1
**Level:** 3
**Parent:** [[2.1-OSI-and-TCPIP-models-Understanding-network-communication-layers|OSI and TCP/IP models: Understanding network communication layers]]
...
- [[2.1.1.1-Physical-Data-Link-Network-layers-Hardware-and-addressing|↓ Physical, Data Link, Network layers: Hardware and addressing]]
- [[2.1.1.2-Transport-and-Session-layers-End-to-end-communication|↓ Transport and Session layers: End-to-end communication]]
- [[2.1.1.3-Presentation-and-Application-layers-Data-format-and-user-interface|↓ Presentation and Application layers: Data format and user interface]]

**Related Topics at Same Level:**
- [[2.1.2-TCPIP-model-four-layer-architecture|→ TCP/IP model four-layer architecture]]
- [[2.1.3-Packet-encapsulation-and-de-encapsulation-process|→ Packet encapsulation and de-encapsulation process]]
