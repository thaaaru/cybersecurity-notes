...
- [[2.8.1.1-Collection-detection-and-analysis-phases|↓ Collection, detection, and analysis phases]]
- [[2.8.1.2-Full-packet-capture-vs-metadata-collection|↓ Full packet capture vs metadata collection]]
- [[2.8.1.3-Network-sensors-and-tap-placement-strategies|↓ Network sensors and tap placement strategies]]

**Related Topics at Same Level:**
- [[2.8.2-Security-Onion-and-open-source-NSM-stack|→ Security Onion and open-source NSM stack]]
