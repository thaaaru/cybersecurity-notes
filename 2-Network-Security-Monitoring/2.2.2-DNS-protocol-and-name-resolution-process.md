...
- [[2.2.2.1-DNS-query-types-Recursive-vs-iterative|↓ DNS query types: Recursive vs iterative]]
- [[2.2.2.2-DNS-record-types-A-AAAA-MX-CNAME-TXT-NS|↓ DNS record types: A, AAAA, MX, CNAME, TXT, NS]]
- [[2.2.2.3-DNS-security-DNSSEC-DNS-over-HTTPS-DoH|↓ DNS security: DNSSEC, DNS over HTTPS (DoH)]]
