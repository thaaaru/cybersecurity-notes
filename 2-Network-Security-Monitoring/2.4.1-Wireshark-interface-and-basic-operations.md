...
**ID:** 2.4.1
**Level:** 3
**Parent:** [[2.4-Introduction-to-packet-analysis-with-Wireshark|Introduction to packet analysis with Wireshark]]
**Tags:** #level3 #tools #module2
...
- [[2.4.1.1-Capture-interfaces-selection-and-promiscuous-mode|↓ Capture interfaces selection and promiscuous mode]]
- [[2.4.1.2-Display-filters-vs-capture-filters|↓ Display filters vs capture filters]]
- [[2.4.1.3-Color-coding-and-packet-highlighting-rules|↓ Color coding and packet highlighting rules]]

**Related Topics at Same Level:**
- [[2.4.2-Protocol-dissection-and-packet-inspection|→ Protocol dissection and packet inspection]]
- [[2.4.3-Common-Wireshark-filters-and-display-techniques|→ Common Wireshark filters and display techniques]]
