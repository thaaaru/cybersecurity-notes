...
- [[2.7.3.1-Verbose-output-levels--v--vv--vvv|↓ Verbose output levels: -v, -vv, -vvv]]
- [[2.7.3.2-ASCII-and-hex-output--A-and--X-options|↓ ASCII and hex output: -A and -X options]]
- [[2.7.3.3-Timestamp-formats-and-precision|↓ Timestamp formats and precision]]
