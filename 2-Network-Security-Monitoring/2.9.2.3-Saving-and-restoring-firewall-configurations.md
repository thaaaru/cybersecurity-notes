...
**ID:** 2.9.2.3
**Level:** 4
**Parent:** [[2.9.2-iptablesnftables-configuration-on-Linux|iptables/nftables configuration on Linux]]
...
- [[2.9.2.1-iptables-chains-INPUT-OUTPUT-FORWARD|→ iptables chains: INPUT, OUTPUT, FORWARD]]
- [[2.9.2.2-NAT-and-port-forwarding-rules|→ NAT and port forwarding rules]]
