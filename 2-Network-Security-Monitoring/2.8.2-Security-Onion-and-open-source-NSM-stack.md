# Security Onion and open-source NSM stack

**ID:** 2.8.2
**Level:** 3
**Parent:** [[2.8-Network-security-monitoring-NSM-concepts-and-tools|Network security monitoring (NSM) concepts and tools]]
**Tags:** #level3 #module2
...
- [[2.8.2.1-Security-Onion-components-Suricata-Zeek-Elasticsearch|↓ Security Onion components: Suricata, Zeek, Elasticsearch]]
- [[2.8.2.2-Alert-triage-and-investigation-workflow|↓ Alert triage and investigation workflow]]
- [[2.8.2.3-Hunt-mode-vs-alert-driven-analysis|↓ Hunt mode vs alert-driven analysis]]

**Related Topics at Same Level:**
- [[2.8.1-NSM-methodology-and-principles|→ NSM methodology and principles]]
- [[2.8.3-Network-traffic-baselining-and-anomaly-detection|→ Network traffic baselining and anomaly detection]]
