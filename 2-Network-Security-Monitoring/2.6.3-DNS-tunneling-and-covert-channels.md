...
**ID:** 2.6.3
**Level:** 3
**Parent:** [[2.6-Identifying-suspicious-patterns-Port-scans-ARP-spoofing-DNS-tunneling|Identifying suspicious patterns: Port scans, ARP spoofing, DNS tunneling]]
**Tags:** #level3 #module2
...
- [[2.6.3.1-Abnormal-DNS-query-patterns-and-frequencies|↓ Abnormal DNS query patterns and frequencies]]
- [[2.6.3.2-TXT-and-NULL-record-abuse-for-data-exfiltration|↓ TXT and NULL record abuse for data exfiltration]]
- [[2.6.3.3-Detecting-DNS-tunneling-with-entropy-analysis|↓ Detecting DNS tunneling with entropy analysis]]

**Related Topics at Same Level:**
- [[2.6.1-Port-scanning-detection-techniques|→ Port scanning detection techniques]]
- [[2.6.2-ARP-spoofing-and-man-in-the-middle-attacks|→ ARP spoofing and man-in-the-middle attacks]]
