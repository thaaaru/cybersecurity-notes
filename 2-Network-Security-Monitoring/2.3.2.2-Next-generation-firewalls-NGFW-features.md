...
**ID:** 2.3.2.2
**Level:** 4
**Parent:** [[2.3.2-Firewalls-Stateful-and-stateless-packet-filtering|Firewalls: Stateful and stateless packet filtering]]
...
- [[2.3.2-Firewalls-Stateful-and-stateless-packet-filtering|↑ Firewalls: Stateful and stateless packet filtering]]

**Related Topics at Same Level:**
- [[2.3.2.1-Firewall-types-Packet-filtering-stateful-inspection-application-level|→ Firewall types: Packet filtering, stateful inspection, application-level]]
- [[2.3.2.3-DMZ-architecture-and-network-segmentation|→ DMZ architecture and network segmentation]]
