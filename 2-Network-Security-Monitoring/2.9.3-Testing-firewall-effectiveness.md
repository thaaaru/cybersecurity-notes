...
**ID:** 2.9.3
**Level:** 3
**Parent:** [[2.9-Firewall-rule-configuration-and-testing|Firewall rule configuration and testing]]
...
- [[2.9.3.1-Using-nmap-to-validate-firewall-rules|↓ Using nmap to validate firewall rules]]
- [[2.9.3.2-Testing-from-internal-and-external-perspectives|↓ Testing from internal and external perspectives]]
- [[2.9.3.3-Firewall-rule-optimization-and-cleanup|↓ Firewall rule optimization and cleanup]]

**Related Topics at Same Level:**
- [[2.9.1-Firewall-rule-syntax-and-logic|→ Firewall rule syntax and logic]]
- [[2.9.2-iptablesnftables-configuration-on-Linux|→ iptables/nftables configuration on Linux]]
