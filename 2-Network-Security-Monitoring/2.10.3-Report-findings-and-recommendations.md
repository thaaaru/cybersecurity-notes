...
- [[2.10.3.1-Document-timeline-of-attack-activities|↓ Document timeline of attack activities]]
- [[2.10.3.2-Extract-IOCs-IP-addresses-domains-file-hashes|↓ Extract IOCs: IP addresses, domains, file hashes]]
- [[2.10.3.3-Propose-detection-rules-and-mitigation-strategies|↓ Propose detection rules and mitigation strategies]]

**Related Topics at Same Level:**
- [[2.10.1-Scenario-setup-and-attack-simulation|→ Scenario setup and attack simulation]]
- [[2.10.2-Traffic-analysis-and-evidence-collection|→ Traffic analysis and evidence collection]]
