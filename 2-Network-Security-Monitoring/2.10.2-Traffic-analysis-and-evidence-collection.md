...
**ID:** 2.10.2
**Level:** 3
**Parent:** [[2.10-Lab-Analyze-a-simulated-network-attack-using-packet-captures|Lab: Analyze a simulated network attack using packet captures]]
...
- [[2.10.2.1-Identify-reconnaissance-phase-Port-scans-and-probes|↓ Identify reconnaissance phase: Port scans and probes]]
- [[2.10.2.2-Detect-exploitation-attempts-and-payload-delivery|↓ Detect exploitation attempts and payload delivery]]
- [[2.10.2.3-Track-command-and-control-communications|↓ Track command and control communications]]

**Related Topics at Same Level:**
- [[2.10.1-Scenario-setup-and-attack-simulation|→ Scenario setup and attack simulation]]
- [[2.10.3-Report-findings-and-recommendations|→ Report findings and recommendations]]
