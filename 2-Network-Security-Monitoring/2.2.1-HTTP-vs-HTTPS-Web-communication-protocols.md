...
- [[2.2.1.1-HTTP-methods-GET-POST-PUT-DELETE|↓ HTTP methods: GET, POST, PUT, DELETE]]
- [[2.2.1.2-TLSSSL-handshake-and-certificate-validation|↓ TLS/SSL handshake and certificate validation]]
- [[2.2.1.3-HTTP-response-codes-and-security-implications|↓ HTTP response codes and security implications]]

**Related Topics at Same Level:**
- [[2.2.2-DNS-protocol-and-name-resolution-process|→ DNS protocol and name resolution process]]
- [[2.2.3-Secure-vs-insecure-remote-access-protocols|→ Secure vs insecure remote access protocols]]
