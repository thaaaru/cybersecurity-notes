# TCP/IP model four-layer architecture
...
- [[2.1.2.1-Network-Access-layer-Ethernet-ARP-MAC-addressing|↓ Network Access layer: Ethernet, ARP, MAC addressing]]
- [[2.1.2.2-Internet-layer-IP-ICMP-routing-protocols|↓ Internet layer: IP, ICMP, routing protocols]]
- [[2.1.2.3-Transport-and-Application-layers-TCP-UDP-application-protocols|↓ Transport and Application layers: TCP, UDP, application protocols]]

**Related Topics at Same Level:**
- [[2.1.1-OSI-Model-seven-layers-breakdown|→ OSI Model seven layers breakdown]]
