...
- [[2.9.1.1-Rule-order-and-first-match-principle|↓ Rule order and first-match principle]]
- [[2.9.1.2-Allow-vs-deny-rules-and-implicit-deny|↓ Allow vs deny rules and implicit deny]]
- [[2.9.1.3-Source-destination-service-and-action-fields|↓ Source, destination, service, and action fields]]
