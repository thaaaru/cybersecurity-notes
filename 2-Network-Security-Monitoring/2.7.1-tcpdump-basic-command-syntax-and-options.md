# tcpdump basic command syntax and options
...
- [[2.7.1.1-Interface-selection-tcpdump--i-eth0|↓ Interface selection: tcpdump -i eth0]]
- [[2.7.1.2-Packet-count-limits--c-option|↓ Packet count limits: -c option]]
- [[2.7.1.3-Saving-to-file--w-and-reading--r-options|↓ Saving to file: -w and reading: -r options]]

**Related Topics at Same Level:**
- [[2.7.2-tcpdump-filter-expressions|→ tcpdump filter expressions]]
