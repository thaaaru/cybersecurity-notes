# Advanced BPF filter combinations

**ID:** 2.5.2
**Level:** 3
**Parent:** [[2.5-Capturing-and-filtering-network-traffic-BPF-filters|Capturing and filtering network traffic (BPF filters)]]
**Tags:** #level3 #module2
...
- [[2.5.2.1-Logical-operators-and-or-not-in-BPF|↓ Logical operators: and, or, not in BPF]]
- [[2.5.2.2-Port-ranges-and-multiple-conditions|↓ Port ranges and multiple conditions]]
- [[2.5.2.3-Excluding-broadcast-and-multicast-traffic|↓ Excluding broadcast and multicast traffic]]

**Related Topics at Same Level:**
- [[2.5.1-Berkeley-Packet-Filter-BPF-syntax|→ Berkeley Packet Filter (BPF) syntax]]
- [[2.5.3-Optimizing-capture-performance|→ Optimizing capture performance]]
