# TheHarvester tool fundamentals

**ID:** 3.6.1
**Level:** 3
**Parent:** [[3.6-Email-harvesting-techniques-using-TheHarvester|Email harvesting techniques using TheHarvester]]
**Tags:** #level3 #module3
...
- [[3.6.1.1-Installation-and-basic-command-syntax|↓ Installation and basic command syntax]]
- [[3.6.1.2-Data-source-selection-Google-Bing-LinkedIn-Shodan|↓ Data source selection: Google, Bing, LinkedIn, Shodan]]
- [[3.6.1.3-Output-formats-and-result-analysis|↓ Output formats and result analysis]]

**Related Topics at Same Level:**
- [[3.6.2-Email-pattern-identification-and-validation|→ Email pattern identification and validation]]
- [[3.6.3-Email-intelligence-for-social-engineering-preparation|→ Email intelligence for social engineering preparation]]
