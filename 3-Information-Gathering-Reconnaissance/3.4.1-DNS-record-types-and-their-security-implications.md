...
- [[3.4.1.1-A-and-AAAA-records-IP-address-resolution|↓ A and AAAA records: IP address resolution]]
- [[3.4.1.2-MX-records-Email-infrastructure-mapping|↓ MX records: Email infrastructure mapping]]
- [[3.4.1.3-TXT-records-SPF-DKIM-DMARC-analysis|↓ TXT records: SPF, DKIM, DMARC analysis]]
