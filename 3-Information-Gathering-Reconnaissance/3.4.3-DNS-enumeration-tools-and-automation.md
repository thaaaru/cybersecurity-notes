# DNS enumeration tools and automation
...
- [[3.4.3.1-DNSdumpster-Sublist3r-Amass|↓ DNSdumpster, Sublist3r, Amass]]
- [[3.4.3.2-Passive-DNS-databases-VirusTotal-SecurityTrails|↓ Passive DNS databases: VirusTotal, SecurityTrails]]
- [[3.4.3.3-Recursive-subdomain-discovery-strategies|↓ Recursive subdomain discovery strategies]]

**Related Topics at Same Level:**
- [[3.4.1-DNS-record-types-and-their-security-implications|→ DNS record types and their security implications]]
- [[3.4.2-Subdomain-enumeration-techniques|→ Subdomain enumeration techniques]]
