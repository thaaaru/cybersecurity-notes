# Reconnaissance planning and scoping

**ID:** 3.10.1
**Level:** 3
**Parent:** [[3.10-Lab-Create-a-complete-reconnaissance-report-on-a-target-organization-authorizedsandbox|Lab: Create a complete reconnaissance report on a target organization (authorized/sandbox)]]
...
- [[3.10.1.1-Define-target-Use-TryHackMe-HackTheBox-or-authorized-domain|↓ Define target: Use TryHackMe, HackTheBox, or authorized domain]]
- [[3.10.1.2-Set-reconnaissance-objectives-and-information-requirements|↓ Set reconnaissance objectives and information requirements]]
- [[3.10.1.3-Document-legal-authorization-and-ethical-boundaries|↓ Document legal authorization and ethical boundaries]]

**Related Topics at Same Level:**
- [[3.10.2-Execute-comprehensive-reconnaissance|→ Execute comprehensive reconnaissance]]
- [[3.10.3-Analysis-and-professional-reporting|→ Analysis and professional reporting]]
