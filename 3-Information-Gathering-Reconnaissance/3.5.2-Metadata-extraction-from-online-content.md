# Metadata extraction from online content

**ID:** 3.5.2
**Level:** 3
**Parent:** [[3.5-Social-media-intelligence-gathering-and-metadata-analysis|Social media intelligence gathering and metadata analysis]]
**Tags:** #level3 #module3
...
- [[3.5.2.1-EXIF-data-from-images-Geolocation-timestamps-devices|↓ EXIF data from images: Geolocation, timestamps, devices]]
- [[3.5.2.2-Document-metadata-Authors-software-versions-internal-paths|↓ Document metadata: Authors, software versions, internal paths]]
- [[3.5.2.3-Using-ExifTool-and-FOCA-for-metadata-analysis|↓ Using ExifTool and FOCA for metadata analysis]]

**Related Topics at Same Level:**
- [[3.5.1-Social-media-platform-reconnaissance|→ Social media platform reconnaissance]]
- [[3.5.3-Social-engineering-intelligence-gathering|→ Social engineering intelligence gathering]]
