# Definition and scope of OSINT in cybersecurity

**ID:** 3.1.1
**Level:** 3
**Parent:** [[3.1-Introduction-to-OSINT-Open-Source-Intelligence-and-its-ethical-use|Introduction to OSINT (Open Source Intelligence) and its ethical use]]
**Tags:** #level3 #reconnaissance #os-security #module3
...
- [[3.1.1.1-OSINT-framework-and-intelligence-lifecycle|↓ OSINT framework and intelligence lifecycle]]
- [[3.1.1.2-OSINT-sources-Public-records-social-media-technical-data|↓ OSINT sources: Public records, social media, technical data]]
- [[3.1.1.3-Difference-between-OSINT-HUMINT-SIGINT|↓ Difference between OSINT, HUMINT, SIGINT]]

**Related Topics at Same Level:**
- [[3.1.2-Legal-and-ethical-boundaries-of-information-gathering|→ Legal and ethical boundaries of information gathering]]
- [[3.1.3-OSINT-use-cases-and-applications|→ OSINT use cases and applications]]
