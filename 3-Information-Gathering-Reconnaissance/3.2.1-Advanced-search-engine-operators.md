...
**ID:** 3.2.1
**Level:** 3
**Parent:** [[3.2-Passive-reconnaissance-Search-engines-Google-Dorks-cached-pages|Passive reconnaissance: Search engines, Google Dorks, cached pages]]
**Tags:** #level3 #module3
...
- [[3.2.1.1-Google-Dorks-site-filetype-intitle-inurl|↓ Google Dorks: site:, filetype:, intitle:, inurl:]]
- [[3.2.1.2-Finding-exposed-files-PDFs-spreadsheets-configuration-files|↓ Finding exposed files: PDFs, spreadsheets, configuration files]]
- [[3.2.1.3-Searching-for-specific-vulnerabilities-and-misconfigurations|↓ Searching for specific vulnerabilities and misconfigurations]]

**Related Topics at Same Level:**
- [[3.2.2-Web-caching-and-archive-services|→ Web caching and archive services]]
- [[3.2.3-Search-engine-alternatives-and-specialized-tools|→ Search engine alternatives and specialized tools]]
