...
- [[3.6.3.1-Mapping-email-addresses-to-organizational-hierarchy|↓ Mapping email addresses to organizational hierarchy]]
- [[3.6.3.2-Identifying-valuable-targets-for-phishing-simulations|↓ Identifying valuable targets for phishing simulations]]
- [[3.6.3.3-Breach-databases-and-credential-exposure-checks|↓ Breach databases and credential exposure checks]]
