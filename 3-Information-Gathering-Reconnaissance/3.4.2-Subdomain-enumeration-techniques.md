...
**ID:** 3.4.2
**Level:** 3
**Parent:** [[3.4-DNS-enumeration-Subdomain-discovery-DNS-records-A-MX-TXT-NS|DNS enumeration: Subdomain discovery, DNS records (A, MX, TXT, NS)]]
...
- [[3.4.2.1-Brute-force-enumeration-with-wordlists|↓ Brute force enumeration with wordlists]]
- [[3.4.2.2-DNS-zone-transfers-AXFR-and-misconfigurations|↓ DNS zone transfers (AXFR) and misconfigurations]]
- [[3.4.2.3-Certificate-transparency-logs-for-subdomain-discovery|↓ Certificate transparency logs for subdomain discovery]]

**Related Topics at Same Level:**
- [[3.4.1-DNS-record-types-and-their-security-implications|→ DNS record types and their security implications]]
- [[3.4.3-DNS-enumeration-tools-and-automation|→ DNS enumeration tools and automation]]
