# Entity types: Domains, IPs, persons, organizations

**ID:** 3.8.1.2
**Level:** 4
**Parent:** [[3.8.1-Maltego-interface-and-transform-basics|Maltego interface and transform basics]]
**Tags:** #level4 #module3
...
- [[3.8.1-Maltego-interface-and-transform-basics|↑ Maltego interface and transform basics]]

**Related Topics at Same Level:**
- [[3.8.1.1-Maltego-CE-vs-commercial-versions|→ Maltego CE vs commercial versions]]
- [[3.8.1.3-Running-transforms-and-building-graphs|→ Running transforms and building graphs]]
