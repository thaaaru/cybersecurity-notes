# Identifying vulnerable and exposed systems

**ID:** 3.7.2
**Level:** 3
**Parent:** [[3.7-Shodan-and-Censys-Finding-exposed-services-and-devices|Shodan and Censys: Finding exposed services and devices]]
**Tags:** #level3 #os-security #module3
...
- [[3.7.2.1-Finding-default-credentials-and-weak-configurations|↓ Finding default credentials and weak configurations]]
- [[3.7.2.2-Industrial-Control-Systems-ICS-and-IoT-devices|↓ Industrial Control Systems (ICS) and IoT devices]]
- [[3.7.2.3-Database-servers-webcams-and-network-devices|↓ Database servers, webcams, and network devices]]

**Related Topics at Same Level:**
- [[3.7.1-Shodan-search-engine-fundamentals|→ Shodan search engine fundamentals]]
- [[3.7.3-Censys-and-alternative-reconnaissance-platforms|→ Censys and alternative reconnaissance platforms]]
