# Custom transforms and integration

**ID:** 3.8.3
**Level:** 3
**Parent:** [[3.8-Using-Maltego-for-visual-reconnaissance-and-relationship-mapping|Using Maltego for visual reconnaissance and relationship mapping]]
**Tags:** #level3 #module3
...
- [[3.8.3.1-Transform-Hub-and-available-data-sources|↓ Transform Hub and available data sources]]
- [[3.8.3.2-Creating-custom-transforms-for-specific-needs|↓ Creating custom transforms for specific needs]]
- [[3.8.3.3-Exporting-and-reporting-findings-from-Maltego|↓ Exporting and reporting findings from Maltego]]
