...
**ID:** 11.2.2
**Level:** 3
**Parent:** [[11.2-Understanding-bug-bounty-scope-and-rules-of-engagement|Understanding bug bounty scope and rules of engagement]]
...
- [[11.2.2.1-Prohibited-testing-methods-DoS-social-engineering-physical-attacks|↓ Prohibited testing methods: DoS, social engineering, physical attacks]]
- [[11.2.2.2-Testing-limits-and-rate-limiting-considerations|↓ Testing limits and rate limiting considerations]]
- [[11.2.2.3-Data-handling-and-privacy-requirements|↓ Data handling and privacy requirements]]

**Related Topics at Same Level:**
- [[11.2.1-Program-scope-definitions|→ Program scope definitions]]
- [[11.2.3-Vulnerability-acceptance-criteria|→ Vulnerability acceptance criteria]]
