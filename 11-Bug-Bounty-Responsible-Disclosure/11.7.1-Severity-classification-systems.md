...
- [[11.7.1.1-Critical-High-Medium-Low-severity-definitions|↓ Critical, High, Medium, Low severity definitions]]
- [[11.7.1.2-Platform-specific-severity-criteria|↓ Platform-specific severity criteria]]
- [[11.7.1.3-Factors-affecting-severity-Authentication-user-interaction-scope|↓ Factors affecting severity: Authentication, user interaction, scope]]

**Related Topics at Same Level:**
- [[11.7.2-Bounty-payout-structures|→ Bounty payout structures]]
