# Known issues and duplicate submissions

**ID:** 11.2.3.2
**Level:** 4
**Parent:** [[11.2.3-Vulnerability-acceptance-criteria|Vulnerability acceptance criteria]]
...
- [[11.2.3.1-Valid-vulnerability-types-per-program|→ Valid vulnerability types per program]]
- [[11.2.3.3-Severity-thresholds-and-minimum-requirements|→ Severity thresholds and minimum requirements]]
