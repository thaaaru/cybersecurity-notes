...
**ID:** 11.5.3
**Level:** 3
**Parent:** [[11.5-Writing-effective-bug-reports-Reproducibility-impact-proof-of-concept|Writing effective bug reports: Reproducibility, impact, proof of concept]]
...
- [[11.5.3.1-Business-impact-Data-exposure-financial-loss-reputation|↓ Business impact: Data exposure, financial loss, reputation]]
- [[11.5.3.2-Technical-impact-System-compromise-privilege-escalation|↓ Technical impact: System compromise, privilege escalation]]
- [[11.5.3.3-CVSS-scoring-and-severity-justification|↓ CVSS scoring and severity justification]]

**Related Topics at Same Level:**
- [[11.5.1-Bug-report-structure-and-components|→ Bug report structure and components]]
- [[11.5.2-Proof-of-Concept-PoC-development|→ Proof of Concept (PoC) development]]
