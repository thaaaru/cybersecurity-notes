...
**ID:** 10.9.1
**Level:** 3
**Parent:** [[10.9-Interview-preparation-Technical-questions-and-behavioral-scenarios|Interview preparation: Technical questions and behavioral scenarios]]
...
- [[10.9.1.1-Fundamentals-Explain-CIA-triad-encryption-firewalls|↓ Fundamentals: Explain CIA triad, encryption, firewalls]]
- [[10.9.1.2-Scenario-based-How-would-you-respond-to-a-ransomware-attack|↓ Scenario-based: How would you respond to a ransomware attack?]]
- [[10.9.1.3-Tool-specific-Explain-how-Nmap-works-Burp-Suite-features|↓ Tool-specific: Explain how Nmap works, Burp Suite features]]

**Related Topics at Same Level:**
- [[10.9.2-Behavioral-and-situational-questions|→ Behavioral and situational questions]]
- [[10.9.3-Practical-assessments-and-challenges|→ Practical assessments and challenges]]
