...
**ID:** 10.4.1
**Level:** 3
**Parent:** [[10.4-Creating-visual-reports-and-risk-matrices-for-stakeholders|Creating visual reports and risk matrices for stakeholders]]
...
- [[10.4.1.1-Charts-and-graphs-Severity-distribution-affected-systems|↓ Charts and graphs: Severity distribution, affected systems]]
- [[10.4.1.2-Network-diagrams-and-attack-flow-visualizations|↓ Network diagrams and attack flow visualizations]]
- [[10.4.1.3-Timeline-graphs-and-trend-analysis|↓ Timeline graphs and trend analysis]]

**Related Topics at Same Level:**
- [[10.4.2-Risk-matrices-and-heat-maps|→ Risk matrices and heat maps]]
- [[10.4.3-Dashboard-creation-for-executive-presentations|→ Dashboard creation for executive presentations]]
