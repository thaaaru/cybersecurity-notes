...
**ID:** 10.6.2
**Level:** 3
**Parent:** [[10.6-Certification-roadmap-CEH-Security-OSCP-CISSP-GIAC-certifications|Certification roadmap: CEH, Security+, OSCP, CISSP, GIAC certifications]]
...
- [[10.6.2.1-Offensive-Security-OSCP-Penetration-testing-hands-on|↓ Offensive Security OSCP: Penetration testing hands-on]]
- [[10.6.2.2-GIAC-certifications-GPEN-GCIH-GCIA-GSEC|↓ GIAC certifications: GPEN, GCIH, GCIA, GSEC]]
- [[10.6.2.3-Cloud-certifications-AWS-Security-Specialty-Azure-Security-Engineer|↓ Cloud certifications: AWS Security Specialty, Azure Security Engineer]]

**Related Topics at Same Level:**
- [[10.6.1-Entry-level-certifications|→ Entry-level certifications]]
- [[10.6.3-Advanced-and-management-certifications|→ Advanced and management certifications]]
