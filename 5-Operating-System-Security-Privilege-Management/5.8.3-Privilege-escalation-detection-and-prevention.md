...
**ID:** 5.8.3
**Level:** 3
**Parent:** [[5.8-Privilege-escalation-vulnerabilities-and-prevention|Privilege escalation vulnerabilities and prevention]]
**Tags:** #level3 #module5
...
- [[5.8.3.1-Enumeration-tools-WinPEAS-LinPEAS-linux-exploit-suggester|↓ Enumeration tools: WinPEAS, LinPEAS, linux-exploit-suggester]]
- [[5.8.3.2-Monitoring-for-suspicious-privilege-use|↓ Monitoring for suspicious privilege use]]
- [[5.8.3.3-Hardening-configurations-to-prevent-escalation|↓ Hardening configurations to prevent escalation]]

**Related Topics at Same Level:**
- [[5.8.1-Windows-privilege-escalation-techniques|→ Windows privilege escalation techniques]]
- [[5.8.2-Linux-privilege-escalation-vectors|→ Linux privilege escalation vectors]]
