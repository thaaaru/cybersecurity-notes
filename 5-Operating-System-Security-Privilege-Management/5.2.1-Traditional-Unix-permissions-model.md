...
**ID:** 5.2.1
**Level:** 3
**Parent:** [[5.2-LinuxUnix-permissions-File-ownership-chmod-umask-ACLs|Linux/Unix permissions: File ownership, chmod, umask, ACLs]]
**Tags:** #level3 #module5
...
- [[5.2.1.1-Read-write-execute-permissions-for-owner-group-others|↓ Read, write, execute permissions for owner, group, others]]
- [[5.2.1.2-chmod-Symbolic-and-octal-notation|↓ chmod: Symbolic and octal notation]]
- [[5.2.1.3-Special-permissions-SUID-SGID-sticky-bit|↓ Special permissions: SUID, SGID, sticky bit]]

**Related Topics at Same Level:**
- [[5.2.2-File-ownership-and-umask|→ File ownership and umask]]
- [[5.2.3-Access-Control-Lists-ACLs-for-granular-control|→ Access Control Lists (ACLs) for granular control]]
