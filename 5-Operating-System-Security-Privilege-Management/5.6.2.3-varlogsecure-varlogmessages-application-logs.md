# /var/log/secure, /var/log/messages, application logs

**ID:** 5.6.2.3
**Level:** 4
**Parent:** [[5.6.2-Important-log-files-and-their-purposes|Important log files and their purposes]]
**Tags:** #level4 #web-security #module5
