...
- [[5.5.3.1-PowerShell-Get-EventLog-and-Get-WinEvent|↓ PowerShell: Get-EventLog and Get-WinEvent]]
- [[5.5.3.2-Windows-Event-Forwarding-WEF|↓ Windows Event Forwarding (WEF)]]
- [[5.5.3.3-Sysmon-for-advanced-logging|↓ Sysmon for advanced logging]]
