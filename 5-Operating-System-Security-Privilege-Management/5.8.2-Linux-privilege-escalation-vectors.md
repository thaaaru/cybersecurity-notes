...
- [[5.8.2.1-SUIDSGID-binaries-and-sudo-misconfigurations|↓ SUID/SGID binaries and sudo misconfigurations]]
- [[5.8.2.2-Kernel-exploits-and-version-vulnerabilities|↓ Kernel exploits and version vulnerabilities]]
- [[5.8.2.3-Cron-jobs-and-PATH-manipulation|↓ Cron jobs and PATH manipulation]]
