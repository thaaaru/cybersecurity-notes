# CIS Benchmark framework and structure

**ID:** 5.9.1
**Level:** 3
**Parent:** [[5.9-Security-baselines-CIS-Benchmarks-for-Windows-and-Linux|Security baselines: CIS Benchmarks for Windows and Linux]]
**Tags:** #level3 #compliance #module5
...
- [[5.9.1.1-Profile-levels-Level-1-basic-vs-Level-2-enhanced|↓ Profile levels: Level 1 (basic) vs Level 2 (enhanced)]]
- [[5.9.1.2-Scored-vs-not-scored-recommendations|↓ Scored vs not scored recommendations]]
- [[5.9.1.3-Implementation-guides-and-remediation-procedures|↓ Implementation guides and remediation procedures]]

**Related Topics at Same Level:**
- [[5.9.2-Key-CIS-controls-for-Windows|→ Key CIS controls for Windows]]
- [[5.9.3-Key-CIS-controls-for-Linux|→ Key CIS controls for Linux]]
