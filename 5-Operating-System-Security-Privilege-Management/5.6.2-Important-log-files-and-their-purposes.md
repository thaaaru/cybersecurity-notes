...
**ID:** 5.6.2
**Level:** 3
**Parent:** [[5.6-Linux-log-files-varlog-syslog-authlog-journalctl|Linux log files: /var/log, syslog, auth.log, journalctl]]
...
- [[5.6.2.1-varlogauthlog-Authentication-and-authorization|↓ /var/log/auth.log: Authentication and authorization]]
- [[5.6.2.2-varlogsyslog-System-messages-and-errors|↓ /var/log/syslog: System messages and errors]]
- [[5.6.2.3-varlogsecure-varlogmessages-application-logs|↓ /var/log/secure, /var/log/messages, application logs]]

**Related Topics at Same Level:**
- [[5.6.1-Linux-logging-architecture|→ Linux logging architecture]]
- [[5.6.3-Log-analysis-with-command-line-tools|→ Log analysis with command-line tools]]
