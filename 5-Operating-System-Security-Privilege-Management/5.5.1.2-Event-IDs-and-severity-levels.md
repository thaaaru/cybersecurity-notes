# Event IDs and severity levels

**ID:** 5.5.1.2
**Level:** 4
**Parent:** [[5.5.1-Windows-Event-Log-structure-and-categories|Windows Event Log structure and categories]]
**Tags:** #level4 #module5
...
- [[5.5.1-Windows-Event-Log-structure-and-categories|↑ Windows Event Log structure and categories]]

**Related Topics at Same Level:**
- [[5.5.1.1-Security-Application-System-Setup-logs|→ Security, Application, System, Setup logs]]
- [[5.5.1.3-Event-Viewer-navigation-and-filtering|→ Event Viewer navigation and filtering]]
