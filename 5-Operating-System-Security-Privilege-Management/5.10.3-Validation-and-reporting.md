...
**ID:** 5.10.3
**Level:** 3
**Parent:** [[5.10-Lab-Audit-and-harden-a-vulnerable-system-Windows-and-Linux|Lab: Audit and harden a vulnerable system (Windows and Linux)]]
**Tags:** #level3 #module5
...
- [[5.10.3.1-Re-run-security-assessment-to-measure-improvement|↓ Re-run security assessment to measure improvement]]
- [[5.10.3.2-Test-functionality-and-verify-no-breakage|↓ Test functionality and verify no breakage]]
- [[5.10.3.3-Create-hardening-report-with-beforeafter-comparison|↓ Create hardening report with before/after comparison]]

**Related Topics at Same Level:**
- [[5.10.1-Initial-security-audit-and-baseline-assessment|→ Initial security audit and baseline assessment]]
- [[5.10.2-System-hardening-implementation|→ System hardening implementation]]
