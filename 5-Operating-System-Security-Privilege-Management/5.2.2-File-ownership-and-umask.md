...
- [[5.2.2.1-chown-and-chgrp-Changing-ownership|↓ chown and chgrp: Changing ownership]]
- [[5.2.2.2-umask-Default-permission-masks|↓ umask: Default permission masks]]
- [[5.2.2.3-Finding-files-by-permissions-find-with--perm|↓ Finding files by permissions: find with -perm]]

**Related Topics at Same Level:**
- [[5.2.1-Traditional-Unix-permissions-model|→ Traditional Unix permissions model]]
