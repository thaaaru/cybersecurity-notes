# Windows Event Log structure and categories

**ID:** 5.5.1
**Level:** 3
**Parent:** [[5.5-Windows-Event-Logs-Security-Application-System-log-analysis|Windows Event Logs: Security, Application, System log analysis]]
...
- [[5.5.1.2-Event-IDs-and-severity-levels|↓ Event IDs and severity levels]]
- [[5.5.1.3-Event-Viewer-navigation-and-filtering|↓ Event Viewer navigation and filtering]]

**Related Topics at Same Level:**
- [[5.5.2-Critical-security-events-to-monitor|→ Critical security events to monitor]]
- [[5.5.3-Log-collection-and-analysis-tools|→ Log collection and analysis tools]]
