...
**ID:** 5.3.1
**Level:** 3
**Parent:** [[5.3-Principle-of-least-privilege-and-role-based-access-control-RBAC|Principle of least privilege and role-based access control (RBAC)]]
**Tags:** #level3 #module5
...
- [[5.3.1.1-Separation-of-duties-and-need-to-know-basis|↓ Separation of duties and need-to-know basis]]
- [[5.3.1.2-Privilege-creep-and-periodic-access-reviews|↓ Privilege creep and periodic access reviews]]
- [[5.3.1.3-Just-in-time-JIT-access-and-time-limited-permissions|↓ Just-in-time (JIT) access and time-limited permissions]]

**Related Topics at Same Level:**
- [[5.3.2-Role-Based-Access-Control-RBAC-model|→ Role-Based Access Control (RBAC) model]]
- [[5.3.3-Privileged-Access-Management-PAM|→ Privileged Access Management (PAM)]]
