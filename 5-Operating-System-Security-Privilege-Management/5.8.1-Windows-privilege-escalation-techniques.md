...
- [[5.8.1.1-Unquoted-service-paths-and-weak-permissions|↓ Unquoted service paths and weak permissions]]
- [[5.8.1.2-DLL-hijacking-and-search-order-vulnerabilities|↓ DLL hijacking and search order vulnerabilities]]
- [[5.8.1.3-Scheduled-tasks-and-registry-manipulation|↓ Scheduled tasks and registry manipulation]]

**Related Topics at Same Level:**
- [[5.8.2-Linux-privilege-escalation-vectors|→ Linux privilege escalation vectors]]
- [[5.8.3-Privilege-escalation-detection-and-prevention|→ Privilege escalation detection and prevention]]
