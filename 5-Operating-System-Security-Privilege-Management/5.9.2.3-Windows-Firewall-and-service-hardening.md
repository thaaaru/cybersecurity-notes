# Windows Firewall and service hardening

**ID:** 5.9.2.3
**Level:** 4
**Parent:** [[5.9.2-Key-CIS-controls-for-Windows|Key CIS controls for Windows]]
**Tags:** #level4 #network-security #os-security #module5
...
- [[5.9.2-Key-CIS-controls-for-Windows|↑ Key CIS controls for Windows]]

**Related Topics at Same Level:**
- [[5.9.2.1-Account-policies-and-password-settings|→ Account policies and password settings]]
- [[5.9.2.2-Audit-policy-and-event-log-configuration|→ Audit policy and event log configuration]]
