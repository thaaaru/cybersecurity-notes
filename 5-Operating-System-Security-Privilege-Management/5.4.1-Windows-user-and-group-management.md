...
**ID:** 5.4.1
**Level:** 3
**Parent:** [[5.4-User-and-group-management-Creating-modifying-and-auditing-accounts|User and group management: Creating, modifying, and auditing accounts]]
...
- [[5.4.1.1-Local-users-lusrmgrmsc-net-user-commands|↓ Local users: lusrmgr.msc, net user commands]]
- [[5.4.1.2-Active-Directory-Users-and-Computers-console|↓ Active Directory: Users and Computers console]]
- [[5.4.1.3-Built-in-groups-Administrators-Users-Power-Users|↓ Built-in groups: Administrators, Users, Power Users]]

**Related Topics at Same Level:**
- [[5.4.2-Linux-user-and-group-administration|→ Linux user and group administration]]
- [[5.4.3-Account-auditing-and-lifecycle-management|→ Account auditing and lifecycle management]]
