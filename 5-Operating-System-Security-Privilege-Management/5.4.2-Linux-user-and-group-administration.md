...
- [[5.4.2.1-useradd-usermod-userdel-commands|↓ useradd, usermod, userdel commands]]
- [[5.4.2.2-groupadd-groupmod-groups-commands|↓ groupadd, groupmod, groups commands]]
- [[5.4.2.3-etcpasswd-etcshadow-etcgroup-files|↓ /etc/passwd, /etc/shadow, /etc/group files]]
