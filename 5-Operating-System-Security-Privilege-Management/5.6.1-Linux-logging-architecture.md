...
- [[5.6.1.1-Syslog-and-rsyslog-configuration|↓ Syslog and rsyslog configuration]]
- [[5.6.1.2-Log-rotation-with-logrotate|↓ Log rotation with logrotate]]
- [[5.6.1.3-systemd-journal-vs-traditional-syslog|↓ systemd journal vs traditional syslog]]

**Related Topics at Same Level:**
- [[5.6.2-Important-log-files-and-their-purposes|→ Important log files and their purposes]]
