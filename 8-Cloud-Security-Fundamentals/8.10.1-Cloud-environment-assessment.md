...
**ID:** 8.10.1
**Level:** 3
**Parent:** [[8.10-Lab-Audit-a-cloud-environment-and-fix-security-misconfigurations|Lab: Audit a cloud environment and fix security misconfigurations]]
...
- [[8.10.1.1-Set-up-AWSAzure-free-tier-account-for-testing|↓ Set up AWS/Azure free tier account for testing]]
- [[8.10.1.2-Run-automated-security-assessment-tools-ScoutSuite-Prowler|↓ Run automated security assessment tools (ScoutSuite, Prowler)]]
- [[8.10.1.3-Identify-misconfigurations-and-security-gaps|↓ Identify misconfigurations and security gaps]]

**Related Topics at Same Level:**
- [[8.10.2-Remediate-identified-issues|→ Remediate identified issues]]
- [[8.10.3-Validate-and-document-improvements|→ Validate and document improvements]]
