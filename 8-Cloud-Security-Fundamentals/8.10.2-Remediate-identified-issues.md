...
- [[8.10.2.1-Fix-public-S3-buckets-and-exposed-resources|↓ Fix public S3 buckets and exposed resources]]
- [[8.10.2.2-Implement-proper-IAM-policies-and-MFA|↓ Implement proper IAM policies and MFA]]
- [[8.10.2.3-Configure-security-groups-and-network-segmentation|↓ Configure security groups and network segmentation]]

**Related Topics at Same Level:**
- [[8.10.1-Cloud-environment-assessment|→ Cloud environment assessment]]
