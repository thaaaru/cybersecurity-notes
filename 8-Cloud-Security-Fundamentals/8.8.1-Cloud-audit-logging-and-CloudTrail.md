...
- [[8.8.1.1-Enabling-CloudTrail-and-log-aggregation|↓ Enabling CloudTrail and log aggregation]]
- [[8.8.1.2-CloudTrail-log-analysis-and-anomaly-detection|↓ CloudTrail log analysis and anomaly detection]]
- [[8.8.1.3-Azure-Activity-Log-and-diagnostic-settings|↓ Azure Activity Log and diagnostic settings]]

**Related Topics at Same Level:**
- [[8.8.2-Threat-detection-services|→ Threat detection services]]
