...
**ID:** 8.6.2
**Level:** 3
**Parent:** [[8.6-Virtual-Private-Cloud-VPC-and-network-segmentation|Virtual Private Cloud (VPC) and network segmentation]]
...
- [[8.6.2.1-Multi-tier-architecture-Web-app-database-layers|↓ Multi-tier architecture: Web, app, database layers]]
- [[8.6.2.2-Isolation-using-multiple-VPCsVNets|↓ Isolation using multiple VPCs/VNets]]
- [[8.6.2.3-Microsegmentation-with-security-groups|↓ Microsegmentation with security groups]]

**Related Topics at Same Level:**
- [[8.6.1-VPC-architecture-and-components|→ VPC architecture and components]]
- [[8.6.3-Azure-Virtual-Network-VNet-equivalent-concepts|→ Azure Virtual Network (VNet) equivalent concepts]]
