...
**Tags:** #level3 #os-security #module8
...
- [[8.4.1.1-Public-S3-buckets-and-ACL-misconfigurations|↓ Public S3 buckets and ACL misconfigurations]]
- [[8.4.1.2-Bucket-policies-and-access-control-best-practices|↓ Bucket policies and access control best practices]]
- [[8.4.1.3-S3-Block-Public-Access-settings|↓ S3 Block Public Access settings]]

**Related Topics at Same Level:**
- [[8.4.2-Database-and-storage-misconfigurations|→ Database and storage misconfigurations]]
