...
**ID:** 8.4.2
**Level:** 3
**Parent:** [[8.4-Common-cloud-misconfigurations-Open-S3-buckets-exposed-databases|Common cloud misconfigurations: Open S3 buckets, exposed databases]]
**Tags:** #level3 #module8
...
- [[8.4.2.1-Publicly-exposed-RDS-CosmosDB-DynamoDB-instances|↓ Publicly exposed RDS, CosmosDB, DynamoDB instances]]
- [[8.4.2.2-Weak-database-authentication-and-default-credentials|↓ Weak database authentication and default credentials]]
- [[8.4.2.3-Database-encryption-and-backup-security|↓ Database encryption and backup security]]

**Related Topics at Same Level:**
- [[8.4.1-S3-bucket-security-and-common-exposures|→ S3 bucket security and common exposures]]
- [[8.4.3-Cloud-misconfiguration-scanning-tools|→ Cloud misconfiguration scanning tools]]
