...
- [[8.1.2.1-Cloud-provider-responsibilities-Physical-security-infrastructure|↓ Cloud provider responsibilities: Physical security, infrastructure]]
- [[8.1.2.2-Customer-responsibilities-Data-applications-access-control|↓ Customer responsibilities: Data, applications, access control]]
- [[8.1.2.3-Shared-responsibilities-by-service-model-IaaS-vs-PaaS-vs-SaaS|↓ Shared responsibilities by service model (IaaS vs PaaS vs SaaS)]]

**Related Topics at Same Level:**
- [[8.1.1-Cloud-service-models-explained|→ Cloud service models explained]]
