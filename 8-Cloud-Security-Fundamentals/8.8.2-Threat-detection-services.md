...
**ID:** 8.8.2
**Level:** 3
**Parent:** [[8.8-Cloud-security-monitoring-CloudTrail-AWS-GuardDuty-Azure-Security-Center|Cloud security monitoring: CloudTrail, AWS GuardDuty, Azure Security Center]]
**Tags:** #level3 #module8
...
- [[8.8.2.1-AWS-GuardDuty-Machine-learning-based-threat-detection|↓ AWS GuardDuty: Machine learning-based threat detection]]
- [[8.8.2.2-Azure-Security-Center-threat-protection|↓ Azure Security Center threat protection]]
- [[8.8.2.3-Alert-investigation-and-response-workflows|↓ Alert investigation and response workflows]]

**Related Topics at Same Level:**
- [[8.8.1-Cloud-audit-logging-and-CloudTrail|→ Cloud audit logging and CloudTrail]]
- [[8.8.3-Cloud-security-monitoring-best-practices|→ Cloud security monitoring best practices]]
