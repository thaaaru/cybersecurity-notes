...
- [[8.3.3.1-Enabling-MFA-for-root-and-IAM-users|↓ Enabling MFA for root and IAM users]]
- [[8.3.3.2-Hardware-tokens-vs-virtual-MFA-devices|↓ Hardware tokens vs virtual MFA devices]]
- [[8.3.3.3-Conditional-access-and-context-aware-authentication|↓ Conditional access and context-aware authentication]]

**Related Topics at Same Level:**
- [[8.3.1-IAM-fundamentals-and-architecture|→ IAM fundamentals and architecture]]
- [[8.3.2-Policy-based-access-control|→ Policy-based access control]]
