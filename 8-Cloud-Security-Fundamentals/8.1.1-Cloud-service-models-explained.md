...
**ID:** 8.1.1
**Level:** 3
**Parent:** [[8.1-Cloud-computing-models-IaaS-PaaS-SaaS-and-shared-responsibility-model|Cloud computing models: IaaS, PaaS, SaaS and shared responsibility model]]
...
- [[8.1.1.1-IaaS-Infrastructure-as-a-Service-EC2-Azure-VMs-compute-resources|↓ IaaS (Infrastructure as a Service): EC2, Azure VMs, compute resources]]
- [[8.1.1.2-PaaS-Platform-as-a-Service-App-Services-Lambda-serverless|↓ PaaS (Platform as a Service): App Services, Lambda, serverless]]
- [[8.1.1.3-SaaS-Software-as-a-Service-Office-365-Salesforce-security-implications|↓ SaaS (Software as a Service): Office 365, Salesforce, security implications]]

**Related Topics at Same Level:**
- [[8.1.2-Shared-responsibility-model|→ Shared responsibility model]]
- [[8.1.3-Cloud-deployment-models|→ Cloud deployment models]]
