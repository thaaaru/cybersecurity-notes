...
**ID:** 8.3.2
**Level:** 3
**Parent:** [[8.3-Identity-and-Access-Management-IAM-Users-roles-policies-MFA|Identity and Access Management (IAM): Users, roles, policies, MFA]]
**Tags:** #level3 #module8
...
- [[8.3.2.1-IAM-policy-structure-Effect-Action-Resource-Condition|↓ IAM policy structure: Effect, Action, Resource, Condition]]
- [[8.3.2.2-Managed-policies-vs-inline-policies|↓ Managed policies vs inline policies]]
- [[8.3.2.3-Least-privilege-principle-in-IAM-policies|↓ Least privilege principle in IAM policies]]

**Related Topics at Same Level:**
- [[8.3.1-IAM-fundamentals-and-architecture|→ IAM fundamentals and architecture]]
- [[8.3.3-MFA-and-advanced-authentication|→ MFA and advanced authentication]]
