...
**ID:** 8.5.1
**Level:** 3
**Parent:** [[8.5-Cloud-storage-security-Encryption-at-rest-and-in-transit|Cloud storage security: Encryption at rest and in transit]]
...
- [[8.5.1.1-Server-side-encryption-SSE-S3-SSE-KMS-SSE-C|↓ Server-side encryption: SSE-S3, SSE-KMS, SSE-C]]
- [[8.5.1.2-Azure-Storage-Service-Encryption-SSE|↓ Azure Storage Service Encryption (SSE)]]
- [[8.5.1.3-Customer-managed-vs-cloud-managed-encryption-keys|↓ Customer-managed vs cloud-managed encryption keys]]

**Related Topics at Same Level:**
- [[8.5.2-Encryption-in-transit|→ Encryption in transit]]
- [[8.5.3-Key-management-and-rotation|→ Key management and rotation]]
