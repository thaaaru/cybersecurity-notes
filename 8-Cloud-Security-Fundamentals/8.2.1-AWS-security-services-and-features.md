...
**ID:** 8.2.1
**Level:** 3
**Parent:** [[8.2-AWSAzure-security-fundamentals-and-service-overview|AWS/Azure security fundamentals and service overview]]
...
- [[8.2.1.1-AWS-IAM-Organizations-and-account-structure|↓ AWS IAM, Organizations, and account structure]]
- [[8.2.1.2-AWS-security-services-GuardDuty-Security-Hub-Inspector|↓ AWS security services: GuardDuty, Security Hub, Inspector]]
- [[8.2.1.3-AWS-Well-Architected-Framework-security-pillar|↓ AWS Well-Architected Framework security pillar]]

**Related Topics at Same Level:**
- [[8.2.2-Azure-security-services-and-features|→ Azure security services and features]]
- [[8.2.3-Cloud-security-best-practices-comparison|→ Cloud security best practices comparison]]
