...
- [[9.3.3.1-Scope-determination-Affected-systems-and-data|↓ Scope determination: Affected systems and data]]
- [[9.3.3.2-Attack-vector-and-entry-point-identification|↓ Attack vector and entry point identification]]
- [[9.3.3.3-Timeline-construction-and-documentation|↓ Timeline construction and documentation]]

**Related Topics at Same Level:**
- [[9.3.1-Event-vs-incident-classification|→ Event vs incident classification]]
