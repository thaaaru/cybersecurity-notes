...
- [[9.7.1.1-Restoring-from-clean-backups|↓ Restoring from clean backups]]
- [[9.7.1.2-Rebuilding-systems-from-trusted-sources|↓ Rebuilding systems from trusted sources]]
- [[9.7.1.3-Data-recovery-and-integrity-validation|↓ Data recovery and integrity validation]]

**Related Topics at Same Level:**
- [[9.7.2-Phased-recovery-approach|→ Phased recovery approach]]
