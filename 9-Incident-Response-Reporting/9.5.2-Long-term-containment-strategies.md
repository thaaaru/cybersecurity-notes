...
- [[9.5.2.1-Patching-vulnerabilities-exploited-by-attacker|↓ Patching vulnerabilities exploited by attacker]]
- [[9.5.2.2-Rebuilding-compromised-systems-from-clean-backups|↓ Rebuilding compromised systems from clean backups]]
- [[9.5.2.3-Architecture-changes-to-prevent-reinfection|↓ Architecture changes to prevent reinfection]]

**Related Topics at Same Level:**
- [[9.5.1-Short-term-containment-actions|→ Short-term containment actions]]
- [[9.5.3-Containment-considerations-and-trade-offs|→ Containment considerations and trade-offs]]
