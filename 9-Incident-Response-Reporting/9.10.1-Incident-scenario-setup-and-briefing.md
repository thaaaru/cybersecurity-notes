# Incident scenario setup and briefing
...
- [[9.10.1.1-Review-simulated-incident-Ransomware-or-phishing-campaign|↓ Review simulated incident: Ransomware or phishing campaign]]
- [[9.10.1.2-Identify-initial-indicators-and-alerts|↓ Identify initial indicators and alerts]]
- [[9.10.1.3-Assemble-incident-response-team-and-assign-roles|↓ Assemble incident response team and assign roles]]

**Related Topics at Same Level:**
- [[9.10.2-Execute-incident-response-procedures|→ Execute incident response procedures]]
- [[9.10.3-Documentation-and-reporting|→ Documentation and reporting]]
