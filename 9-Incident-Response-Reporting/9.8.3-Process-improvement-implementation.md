...
- [[9.8.3.1-Updating-incident-response-playbooks|↓ Updating incident response playbooks]]
- [[9.8.3.2-Implementing-new-security-controls|↓ Implementing new security controls]]
- [[9.8.3.3-Training-and-awareness-based-on-lessons-learned|↓ Training and awareness based on lessons learned]]

**Related Topics at Same Level:**
- [[9.8.1-Post-incident-review-meeting|→ Post-incident review meeting]]
