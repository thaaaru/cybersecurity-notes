...
- [[9.9.2.1-Memory-acquisition-DumpIt-FTK-Imager-WinPMEM|↓ Memory acquisition: DumpIt, FTK Imager, WinPMEM]]
- [[9.9.2.2-Disk-imaging-Write-blockers-dd-FTK-Imager|↓ Disk imaging: Write-blockers, dd, FTK Imager]]
- [[9.9.2.3-Network-traffic-capture-for-analysis|↓ Network traffic capture for analysis]]

**Related Topics at Same Level:**
- [[9.9.1-Forensic-evidence-types|→ Forensic evidence types]]
