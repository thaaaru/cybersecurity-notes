...
**ID:** 9.4.1
**Level:** 3
**Parent:** [[9.4-Indicators-of-Compromise-IOCs-IPs-domains-file-hashes-patterns|Indicators of Compromise (IOCs): IPs, domains, file hashes, patterns]]
**Tags:** #level3 #module9
...
- [[9.4.1.1-Network-indicators-IP-addresses-domains-URLs|↓ Network indicators: IP addresses, domains, URLs]]
- [[9.4.1.2-Host-indicators-File-hashes-MD5-SHA-256-registry-keys-file-paths|↓ Host indicators: File hashes (MD5, SHA-256), registry keys, file paths]]
- [[9.4.1.3-Behavioral-indicators-Unusual-processes-lateral-movement-patterns|↓ Behavioral indicators: Unusual processes, lateral movement patterns]]

**Related Topics at Same Level:**
- [[9.4.2-IOC-collection-and-sharing|→ IOC collection and sharing]]
- [[9.4.3-IOC-analysis-and-hunting|→ IOC analysis and hunting]]
