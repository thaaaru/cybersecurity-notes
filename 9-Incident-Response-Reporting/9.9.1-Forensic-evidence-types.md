...
**ID:** 9.9.1
**Level:** 3
**Parent:** [[9.9-Digital-forensics-basics-Evidence-preservation-and-chain-of-custody|Digital forensics basics: Evidence preservation and chain of custody]]
...
- [[9.9.1.1-Volatile-data-Memory-network-connections-running-processes|↓ Volatile data: Memory, network connections, running processes]]
- [[9.9.1.2-Non-volatile-data-Disk-images-log-files-registry|↓ Non-volatile data: Disk images, log files, registry]]
- [[9.9.1.3-Order-of-volatility-and-collection-priorities|↓ Order of volatility and collection priorities]]

**Related Topics at Same Level:**
- [[9.9.2-Evidence-acquisition-techniques|→ Evidence acquisition techniques]]
- [[9.9.3-Chain-of-custody-and-legal-considerations|→ Chain of custody and legal considerations]]
