...
**ID:** 9.2.1
**Level:** 3
**Parent:** [[9.2-Preparation-Building-an-incident-response-plan-and-toolkit|Preparation: Building an incident response plan and toolkit]]
...
- [[9.2.1.1-Defining-incident-categories-and-severity-levels|↓ Defining incident categories and severity levels]]
- [[9.2.1.2-Contact-lists-escalation-paths-communication-protocols|↓ Contact lists, escalation paths, communication protocols]]
- [[9.2.1.3-Playbooks-for-common-incident-types-ransomware-DDoS-data-breach|↓ Playbooks for common incident types (ransomware, DDoS, data breach)]]

**Related Topics at Same Level:**
- [[9.2.2-Incident-response-toolkit-and-resources|→ Incident response toolkit and resources]]
- [[9.2.3-Training-and-readiness-exercises|→ Training and readiness exercises]]
