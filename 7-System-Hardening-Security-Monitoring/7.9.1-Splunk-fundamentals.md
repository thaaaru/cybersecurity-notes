...
**ID:** 7.9.1
**Level:** 3
**Parent:** [[7.9-Security-monitoring-with-Splunk-or-ELK-Stack-basics|Security monitoring with Splunk or ELK Stack basics]]
**Tags:** #level3 #module7
...
- [[7.9.1.1-Installing-Splunk-and-adding-data-sources|↓ Installing Splunk and adding data sources]]
- [[7.9.1.2-SPL-Search-Processing-Language-basics|↓ SPL (Search Processing Language) basics]]
- [[7.9.1.3-Creating-dashboards-and-visualizations|↓ Creating dashboards and visualizations]]
