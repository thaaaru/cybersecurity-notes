# SIEM use cases and detection scenarios

**ID:** 7.7.2
**Level:** 3
**Parent:** [[7.7-Introduction-to-SIEM-Centralized-log-collection-and-analysis|Introduction to SIEM: Centralized log collection and analysis]]
**Tags:** #level3 #incident-response #os-security #module7
...
- [[7.7.2.1-Security-event-monitoring-and-alerting|↓ Security event monitoring and alerting]]
- [[7.7.2.2-Compliance-reporting-and-audit-trails|↓ Compliance reporting and audit trails]]
- [[7.7.2.3-Threat-intelligence-integration|↓ Threat intelligence integration]]
