...
- [[7.4.1.1-Windows-servicesmsc-Get-Service-sc-query|↓ Windows: services.msc, Get-Service, sc query]]
- [[7.4.1.2-Linux-systemctl-list-units-service---status-all|↓ Linux: systemctl list-units, service --status-all]]
- [[7.4.1.3-Identifying-non-essential-services-safely|↓ Identifying non-essential services safely]]
