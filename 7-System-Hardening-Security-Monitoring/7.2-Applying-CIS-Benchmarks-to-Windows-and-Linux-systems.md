# Applying CIS Benchmarks to Windows and Linux systems

**ID:** 7.2
**Level:** 2
**Parent:** [[7-System-Hardening-Security-Monitoring|System Hardening & Security Monitoring]]
**Tags:** #level2 #os-security #module7
...
- [[7.2.1-CIS-Benchmark-assessment-tools|↓ CIS Benchmark assessment tools]]
- [[7.2.2-Priority-CIS-controls-implementation|↓ Priority CIS controls implementation]]
- [[7.2.3-Compliance-tracking-and-reporting|↓ Compliance tracking and reporting]]
