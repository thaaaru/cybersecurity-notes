...
**ID:** 7.5.3
**Level:** 3
**Parent:** [[7.5-Host-based-firewalls-iptables-Windows-Firewall-configuration|Host-based firewalls: iptables, Windows Firewall configuration]]
**Tags:** #level3 #network-security #module7
...
- [[7.5.3.1-Logging-blocked-connections-for-analysis|↓ Logging blocked connections for analysis]]
- [[7.5.3.2-Testing-firewall-rules-with-netcat-and-nmap|↓ Testing firewall rules with netcat and nmap]]
- [[7.5.3.3-UFW-Uncomplicated-Firewall-for-simplified-management|↓ UFW (Uncomplicated Firewall) for simplified management]]
