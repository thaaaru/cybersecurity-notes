...
- [[7.3.2.1-CISA-Known-Exploited-Vulnerabilities-KEV-catalog|↓ CISA Known Exploited Vulnerabilities (KEV) catalog]]
- [[7.3.2.2-Risk-based-prioritization-CVSS-exploitability|↓ Risk-based prioritization: CVSS + exploitability]]
- [[7.3.2.3-Asset-criticality-and-business-impact-assessment|↓ Asset criticality and business impact assessment]]
