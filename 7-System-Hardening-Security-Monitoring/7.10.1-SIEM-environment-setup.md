...
**ID:** 7.10.1
**Level:** 3
**Parent:** [[7.10-Lab-Configure-monitoring-alerts-and-respond-to-simulated-security-events|Lab: Configure monitoring alerts and respond to simulated security events]]
...
- [[7.10.1.1-Deploy-Splunk-Free-or-ELK-Stack-in-lab-environment|↓ Deploy Splunk Free or ELK Stack in lab environment]]
- [[7.10.1.2-Configure-log-forwarding-from-Windows-and-Linux-systems|↓ Configure log forwarding from Windows and Linux systems]]
- [[7.10.1.3-Verify-log-ingestion-and-parsing|↓ Verify log ingestion and parsing]]
