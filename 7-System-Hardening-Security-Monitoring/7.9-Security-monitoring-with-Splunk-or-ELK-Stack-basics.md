# Security monitoring with Splunk or ELK Stack basics
...
- [[7.9.1-Splunk-fundamentals|↓ Splunk fundamentals]]
- [[7.9.2-ELK-Stack-Elasticsearch-Logstash-Kibana-basics|↓ ELK Stack (Elasticsearch, Logstash, Kibana) basics]]
- [[7.9.3-Security-monitoring-use-cases|↓ Security monitoring use cases]]
