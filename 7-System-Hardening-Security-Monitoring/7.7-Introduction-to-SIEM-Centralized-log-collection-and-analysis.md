# Introduction to SIEM: Centralized log collection and analysis

**ID:** 7.7
**Level:** 2
**Parent:** [[7-System-Hardening-Security-Monitoring|System Hardening & Security Monitoring]]
**Tags:** #level2 #incident-response #module7
...
- [[7.7.1-SIEM-architecture-and-components|↓ SIEM architecture and components]]
- [[7.7.2-SIEM-use-cases-and-detection-scenarios|↓ SIEM use cases and detection scenarios]]
- [[7.7.3-Popular-SIEM-platforms-overview|↓ Popular SIEM platforms overview]]
