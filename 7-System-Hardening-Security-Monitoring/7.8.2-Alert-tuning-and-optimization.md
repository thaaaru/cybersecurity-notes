...
**ID:** 7.8.2
**Level:** 3
**Parent:** [[7.8-Log-correlation-and-alert-tuning-to-reduce-false-positives|Log correlation and alert tuning to reduce false positives]]
**Tags:** #level3 #module7
...
- [[7.8.2.1-Baseline-establishment-and-threshold-tuning|↓ Baseline establishment and threshold tuning]]
- [[7.8.2.2-Suppression-rules-for-known-false-positives|↓ Suppression rules for known false positives]]
- [[7.8.2.3-Alert-severity-classification-and-prioritization|↓ Alert severity classification and prioritization]]
