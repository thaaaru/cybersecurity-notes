...
- [[1.5.3.1-Ransomware-kill-chain-Infection-to-encryption-to-payment|↓ Ransomware kill chain: Infection to encryption to payment]]
- [[1.5.3.2-Double-extortion-and-data-leak-sites|↓ Double extortion and data leak sites]]
- [[1.5.3.3-Prevention-and-response-strategies|↓ Prevention and response strategies]]

**Related Topics at Same Level:**
- [[1.5.1-Phishing-and-social-engineering-attacks|→ Phishing and social engineering attacks]]
