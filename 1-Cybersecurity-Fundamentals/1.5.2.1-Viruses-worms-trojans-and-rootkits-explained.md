...
**ID:** 1.5.2.1
**Level:** 4
**Parent:** [[1.5.2-Malware-types-and-delivery-mechanisms|Malware types and delivery mechanisms]]
...
- [[1.5.2.2-Spyware-adware-and-potentially-unwanted-programs-PUPs|→ Spyware, adware, and potentially unwanted programs (PUPs)]]
- [[1.5.2.3-Delivery-methods-Malicious-attachments-drive-by-downloads-exploit-kits|→ Delivery methods: Malicious attachments, drive-by downloads, exploit kits]]
