...
- [[1.7.1.1-Hardware-assets-Servers-workstations-network-devices|↓ Hardware assets: Servers, workstations, network devices]]
- [[1.7.1.2-Software-assets-Applications-databases-operating-systems|↓ Software assets: Applications, databases, operating systems]]
- [[1.7.1.3-Information-assets-Customer-data-intellectual-property-financial-records|↓ Information assets: Customer data, intellectual property, financial records]]

**Related Topics at Same Level:**
- [[1.7.2-Threat-modeling-methodologies|→ Threat modeling methodologies]]
