# Bypassing MFA: SIM swapping, phishing-resistant methods

**ID:** 1.8.2.3
**Level:** 4
**Parent:** [[1.8.2-Multi-factor-authentication-MFA-implementation|Multi-factor authentication (MFA) implementation]]
**Tags:** #level4 #module1
