...
**ID:** 1.5.1
**Level:** 3
**Parent:** [[1.5-Common-attack-vectors-Phishing-malware-social-engineering-ransomware|Common attack vectors: Phishing, malware, social engineering, ransomware]]
**Tags:** #level3 #module1
...
- [[1.5.1.1-Email-phishing-Spear-phishing-vs-mass-phishing-campaigns|↓ Email phishing: Spear phishing vs mass phishing campaigns]]
- [[1.5.1.2-Vishing-voice-phishing-and-smishing-SMS-phishing|↓ Vishing (voice phishing) and smishing (SMS phishing)]]
- [[1.5.1.3-Pretexting-baiting-and-tailgating-techniques|↓ Pretexting, baiting, and tailgating techniques]]

**Related Topics at Same Level:**
- [[1.5.2-Malware-types-and-delivery-mechanisms|→ Malware types and delivery mechanisms]]
- [[1.5.3-Ransomware-attacks-and-encryption-based-extortion|→ Ransomware attacks and encryption-based extortion]]
