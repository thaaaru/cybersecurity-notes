...
- [[1.8.2.1-Authentication-factors-Something-you-know-have-are|↓ Authentication factors: Something you know, have, are]]
- [[1.8.2.2-MFA-methods-SMS-codes-authenticator-apps-hardware-tokens|↓ MFA methods: SMS codes, authenticator apps, hardware tokens]]
- [[1.8.2.3-Bypassing-MFA-SIM-swapping-phishing-resistant-methods|↓ Bypassing MFA: SIM swapping, phishing-resistant methods]]

**Related Topics at Same Level:**
- [[1.8.1-Strong-password-creation-and-management|→ Strong password creation and management]]
- [[1.8.3-Software-updates-and-patch-management-discipline|→ Software updates and patch management discipline]]
