...
**ID:** 1.7.2
**Level:** 3
**Parent:** [[1.7-Risk-assessment-basics-Asset-identification-threat-modeling-risk-scoring|Risk assessment basics: Asset identification, threat modeling, risk scoring]]
**Tags:** #level3 #module1
...
- [[1.7.2.1-STRIDE-model-Spoofing-Tampering-Repudiation-Information-disclosure-DoS-Elevation|↓ STRIDE model: Spoofing, Tampering, Repudiation, Information disclosure, DoS, Elevation]]
- [[1.7.2.2-Attack-trees-and-threat-scenario-development|↓ Attack trees and threat scenario development]]
- [[1.7.2.3-Identifying-vulnerabilities-and-attack-surfaces|↓ Identifying vulnerabilities and attack surfaces]]

**Related Topics at Same Level:**
- [[1.7.1-Asset-identification-and-inventory-management|→ Asset identification and inventory management]]
- [[1.7.3-Risk-scoring-and-prioritization-frameworks|→ Risk scoring and prioritization frameworks]]
