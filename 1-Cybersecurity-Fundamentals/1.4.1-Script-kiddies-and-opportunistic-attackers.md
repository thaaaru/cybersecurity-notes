...
- [[1.4.1.1-Characteristics-and-typical-attack-methods|↓ Characteristics and typical attack methods]]
- [[1.4.1.2-Tools-commonly-used-Metasploit-automated-scanners|↓ Tools commonly used: Metasploit, automated scanners]]
- [[1.4.1.3-Defense-strategies-against-automated-attacks|↓ Defense strategies against automated attacks]]

**Related Topics at Same Level:**
- [[1.4.2-Organized-cybercrime-groups-and-financial-motivation|→ Organized cybercrime groups and financial motivation]]
- [[1.4.3-Advanced-Persistent-Threats-APTs-and-nation-state-actors|→ Advanced Persistent Threats (APTs) and nation-state actors]]
