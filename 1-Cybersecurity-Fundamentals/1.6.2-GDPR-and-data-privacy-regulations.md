...
**ID:** 1.6.2
**Level:** 3
**Parent:** [[1.6-Compliance-frameworks-overview-ISO-27001-GDPR-PCI-DSS|Compliance frameworks overview: ISO 27001, GDPR, PCI-DSS]]
...
- [[1.6.2.1-GDPR-principles-Lawfulness-purpose-limitation-data-minimization|↓ GDPR principles: Lawfulness, purpose limitation, data minimization]]
- [[1.6.2.2-Data-subject-rights-Access-erasure-portability|↓ Data subject rights: Access, erasure, portability]]
- [[1.6.2.3-Breach-notification-requirements-and-penalties|↓ Breach notification requirements and penalties]]

**Related Topics at Same Level:**
- [[1.6.1-ISO-27001-Information-Security-Management-System-ISMS|→ ISO 27001 Information Security Management System (ISMS)]]
- [[1.6.3-PCI-DSS-for-payment-card-data-protection|→ PCI-DSS for payment card data protection]]
