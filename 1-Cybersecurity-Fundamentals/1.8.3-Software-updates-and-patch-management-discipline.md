# Software updates and patch management discipline

**ID:** 1.8.3
**Level:** 3
**Parent:** [[1.8-Cyber-hygiene-best-practices-Password-management-MFA-software-updates|Cyber hygiene best practices: Password management, MFA, software updates]]
...
- [[1.8.3.1-Zero-day-vulnerabilities-and-patch-Tuesday|↓ Zero-day vulnerabilities and patch Tuesday]]
- [[1.8.3.2-Automatic-updates-vs-manual-testing|↓ Automatic updates vs manual testing]]
- [[1.8.3.3-End-of-life-software-and-upgrade-planning|↓ End-of-life software and upgrade planning]]

**Related Topics at Same Level:**
- [[1.8.1-Strong-password-creation-and-management|→ Strong password creation and management]]
- [[1.8.2-Multi-factor-authentication-MFA-implementation|→ Multi-factor authentication (MFA) implementation]]
