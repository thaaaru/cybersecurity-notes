...
**ID:** 1.2.1
**Level:** 3
**Parent:** [[1.2-CIA-Triad-Confidentiality-Integrity-and-Availability-with-practical-examples|CIA Triad: Confidentiality, Integrity, and Availability with practical examples]]
**Tags:** #level3 #module1
...
- [[1.2.1.1-Encryption-methods-Symmetric-vs-asymmetric-encryption|↓ Encryption methods: Symmetric vs asymmetric encryption]]
- [[1.2.1.2-Access-control-mechanisms-DAC-MAC-RBAC|↓ Access control mechanisms: DAC, MAC, RBAC]]
- [[1.2.1.3-Data-classification-Public-internal-confidential-restricted|↓ Data classification: Public, internal, confidential, restricted]]

**Related Topics at Same Level:**
- [[1.2.2-Integrity-Ensuring-data-accuracy-and-preventing-unauthorized-modification|→ Integrity: Ensuring data accuracy and preventing unauthorized modification]]
- [[1.2.3-Availability-Maintaining-reliable-system-access-and-uptime|→ Availability: Maintaining reliable system access and uptime]]
