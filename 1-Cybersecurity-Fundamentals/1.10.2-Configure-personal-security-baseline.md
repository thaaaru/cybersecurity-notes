# Configure personal security baseline

**ID:** 1.10.2
**Level:** 3
**Parent:** [[1.10-Lab-Set-up-a-secure-personal-cybersecurity-environment|Lab: Set up a secure personal cybersecurity environment]]
**Tags:** #level3 #module1
...
- [[1.10.2.1-Enable-full-disk-encryption-BitLocker-FileVault-LUKS|↓ Enable full disk encryption: BitLocker, FileVault, LUKS]]
- [[1.10.2.2-Set-up-password-manager-and-generate-strong-passwords|↓ Set up password manager and generate strong passwords]]
- [[1.10.2.3-Enable-MFA-on-critical-accounts-Email-banking-social-media|↓ Enable MFA on critical accounts: Email, banking, social media]]

**Related Topics at Same Level:**
- [[1.10.1-Install-and-configure-essential-security-tools|→ Install and configure essential security tools]]
- [[1.10.3-Document-and-verify-security-posture|→ Document and verify security posture]]
